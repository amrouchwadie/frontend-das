...
@Component({
  selector: 'app-consultingprog1',
  templateUrl: './consultingprog1.component.html',
  styleUrls: ['./consultingprog1.component.css']
})
export class Consultingprog1Component implements OnInit {
